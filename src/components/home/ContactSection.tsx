...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="section-padding bg-muted/5">
              ...
              <motion.div variants={itemVariants} className="glass-card p-6 rounded-lg">
                ...
                <div className="flex gap-4">
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="h-10 w-10 rounded-full bg-muted/20 flex items-center justify-center hover:bg-primary/20 transition-colors"
                  >
